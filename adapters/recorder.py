...
History reads go over the bus: a queryable on home/history/** answers
GET home/history/{state|cmd}/{entity}/{aspect}?from=..;to=..;limit=..
with one reply per concrete series, a JSON array of {ts, room, value}.
"""
...
def parse_params(raw: str) -> tuple[int, int, int]:
    ...
    (zenoh's `a=1;b=2` grammar). No URL decoding: RFC3339 offsets contain
